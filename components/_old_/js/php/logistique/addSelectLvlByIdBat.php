...
if(isset($idBat)){
    ...
    $html='<div class="input-group" style="width:650px;">'
            . '<span class="input-group-addon" style="min-width:200px;">Niveau</span>'
            . '<select required class="form-control" name="selectedNivNewMob" id="selectedNivNewMob" onchange="addSelectLclByIdBat();"><option value="-1"></option>';
    while($row=$req->fetch()){
